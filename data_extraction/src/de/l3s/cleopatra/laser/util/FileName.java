package de.l3s.cleopatra.laser.util;

import de.l3s.cleopatra.laser.model.Language;
import de.l3s.cleopatra.laser.model.Source;
...
public enum FileName {
	...
	WIKIDATA_SUB_LOCATION_PROPERTY_NAMES(
			...
			false,
			false),
	WIKIDATA_EVENT_BLACKLIST_CLASSES("event_blacklist_classes.tsv", Source.WIKIDATA, FileType.META, false, true, false),
	...
	EVALUATION_EVENT_EXAMPLES("event_examples.tsv", Source.ALL, FileType.EVALUATION, false, true, false),
	EVALUATION_EVENT_EXAMPLE_RESULTS(
			"event_example_results.tsv",
			Source.ALL,
			FileType.EVALUATION_RESULTS,
			false,
			false,
			false);
	...
	public boolean isEvaluationData() {
		return this.fileType == FileType.EVALUATION;
	}

	public boolean isEvaluationResultsData() {
		return this.fileType == FileType.EVALUATION_RESULTS;
	}
